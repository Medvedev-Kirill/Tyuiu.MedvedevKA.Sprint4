...
using Tyuiu.MedvedevKA.Sprint4.Task3.V14.Lib;

namespace Tyuiu.MedvedevKA.Sprint4.Task3.V14
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Дан двумерный целочисленный массив 5 на 5 элементов, заполненный статическими значениями в диапазоне от 2 до 7. *");
